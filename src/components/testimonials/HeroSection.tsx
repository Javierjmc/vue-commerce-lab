    ...
    <section className="relative overflow-hidden border-0">
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <svg viewBox="0 0 1440 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full">
          <path d="M0 50L48 45.7C96 41 192 33 288 37.8C384 43 480 61 576 66.3C672 72 768 64 864 53.2C960 43 1056 29 1152 26.2C1248 23 1344 31 1392 34.8L1440 39V100H1392C1344 100 1248 100 1152 100C1056 100 960 100 864 100C768 100 672 100 576 100C480 100 384 100 288 100C192 100 96 100 48 100H0V50Z" />
        </svg>
      </div>
    </section>
  );
